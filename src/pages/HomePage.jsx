    ...
    <>
      ...
      <div className="max-w-[1400px] mx-auto w-full px-6 md:px-12 border-x border-slate-200 min-h-screen flex flex-col">
        ...
        <section className="border-b border-slate-200">
          <div className="grid grid-cols-1 md:grid-cols-12">
            <div id="about" className="md:col-span-5 py-16 md:border-e border-slate-200 md:pe-12">
            ...
            <div id="skills" className="md:col-span-7 py-16 md:ps-12 border-t md:border-t-0 border-slate-200">
              <h3 className="text-sm font-bold uppercase tracking-widest text-slate-400 mb-8">
                {sections.expertise}
              </h3>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
            ...
            <div className="flex flex-col items-start md:items-end gap-8">
              <div className="flex gap-4">
                <Button variant="social" shape="icon" href={personal.socials.github}>
                  <GithubIcon className="w-6 h-6" />
                </Button>
                <Button variant="social" shape="icon" href={personal.socials.linkedin}>
                  <LinkedinIcon className="w-6 h-6" />
                </Button>
                <Button variant="social" shape="icon" href={personal.socials.instagram}>
